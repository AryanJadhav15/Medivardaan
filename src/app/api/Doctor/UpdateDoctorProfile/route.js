...
export async function PUT(request) {
  try {
    ...
    const url = `${BASE_URL}${API_CONFIG.ENDPOINTS.DOCTOR.UPDATE}`;

    console.log('[Doctor Update] Putting to:', url);
    console.log('[Doctor Update] Payload:', JSON.stringify(doctorData, null, 2));
    ...
    console.log('[Doctor Update] Success. Status:', response.status);
    ...
    console.error('[Doctor Update] Error. Status:', upstreamStatus);
    console.error('[Doctor Update] Message:', error.message);
