  ...
  return (
    <div className="w-full min-h-screen bg-white dark:bg-[#18122B] p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row gap-4 items-end bg-white dark:bg-[#393053] p-4 rounded-lg border border-gray-200 dark:border-[#443C68]/50">
       ...
       {/* Summary Stats */}
      <div className="flex justify-between items-center text-sm font-medium text-gray-600 dark:text-white/60 px-2">
          ...
          <TableBody>
            {currentItems.map((row, index) => (
              ...
              >
                ...
                <TableCell className="text-gray-600 dark:text-white/75 border-r border-gray-200 dark:border-[#443C68]/50 py-3 text-right font-medium">
                  {row.treatmentPaid}
                </TableCell>
                ...
                <TableCell className="text-gray-600 dark:text-white/75 border-r border-gray-200 dark:border-[#443C68]/50 py-3 text-right">
                 ...
                 <TableCell className="text-gray-600 dark:text-white/75 py-3 text-right font-medium">
                  {row.total}
                </TableCell>
              </TableRow>
            ))}
