            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  ...
                  {!doctors.length && (
                    <SelectItem value="dr-mock">Dr. Mock</SelectItem>
                  )}
                </SelectContent>
              </Select>
>>>>>>> 77fc8ec (UI refinments)
...
=======
              <Table>
                <TableHeader>
                  <TableRow className="border-b border-gray-100 dark:border-[#443C68]/50 hover:bg-primary/10 dark:hover:bg-[#393053]">
                    <TableHead className="font-bold text-gray-700 dark:text-white/75 h-10">
                      Sr. No.
                    </TableHead>
                    <TableHead className="font-bold text-gray-700 dark:text-white/75 h-10">
                      Invoice No.
                    ...
                    <TableHead className="font-bold text-gray-700 dark:text-white/75 h-10 text-right">
                      Total
                    </TableHead>
                    <TableHead className="font-bold text-gray-700 dark:text-white/75 h-10 text-right">
                      Paid
                    ...
                    <TableHead className="font-bold text-gray-700 dark:text-white/75 h-10 text-center">
                      Actions
                    </TableHead>
                  </TableRow>
                </TableHeader>
                  ...
                  {currentItems.length > 0 ? (
                    currentItems.map((inv, index) => (
                      ...
                      >
                        ...
                        <TableCell className="py-2 font-medium text-primary cursor-pointer hover:underline">
                          {inv.invoiceNo}
                        </TableCell>
                        <TableCell className="py-2 text-gray-600 dark:text-white/75">
                          {inv.clinicName}
