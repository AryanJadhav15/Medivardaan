...
export function Pagination({
  ...
  const btnNav =
    "h-8 w-8 p-0 flex items-center justify-center bg-white dark:bg-[#18122B] border border-gray-300 dark:border-[#635985]/40 text-gray-700 dark:text-white/80 hover:bg-gray-100 dark:hover:bg-[#393053] transition-colors rounded";

  return (
    <div className={`flex items-center justify-end gap-1 flex-wrap ${className}`}>
      {/* Page info */}
